...
class _SignupStep2State extends State<SignupStep2> {
  ...
  Widget buildPhoneField(double screenWidth) => Directionality(
        textDirection: TextDirection.ltr, // Set overall text direction to LTR
        child: Row(
          children: [
            Expanded(
              flex: 2, // First Expanded field (first part of the phone number)
              child: Container(
                ...
                child: Directionality(
                  textDirection:
                      TextDirection.ltr, // Ensure LTR inside TextField
                  child: Row(
                    children: [
                      Icon(Icons.phone,
                          size: 18,
            ...
            Expanded(
              flex:
                  5, // Second Expanded field (second part of the phone number)
              child: Container(
                padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.03),
                decoration: BoxDecoration(
                  color: Colors.white,
